...
use momo_lib::{playlist::get_all_playlists, GlobalState};
use std::sync::Mutex;
use tauri::Manager;
...
fn can_get_all_playlists() {
    tauri::test::mock_builder()
        ...
        .setup(|app| {
            ...
            common::create_playlist("Playlist #1", app.state()).unwrap();
            common::create_playlist("Playlist #2", app.state()).unwrap();
            common::create_playlist("Playlist #3", app.state()).unwrap();
